...
namespace Kaazing.JMS.Demo
{
    ...
    public partial class StompDemoForm : Form
    {
        ...
        public StompDemoForm()
        {
            ...
            String defaultLocation = "ws://localhost:8001/jms";
        ...
        private void JMS_Connect()
        {
            ...
            try
            {
                IConnectionFactory connectionFactory = new StompConnectionFactory(new Uri(LocationText.Text));
        ...
        private void UnsubscribeButton_Click(object sender, EventArgs e)
        {
            ...
            //consumers[DestinationText.Text].Close()
        }
